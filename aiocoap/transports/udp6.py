...
class TransportEndpointUDP6(RecvmsgDatagramProtocol, interfaces.TransportEndpoint):
    ...
    @classmethod
    @asyncio.coroutine
    def _create_transport_endpoint(cls, new_message_callback, new_error_callback, log, loop, dump_to, bind, family, multicast=False):
    ...
    def create_client_transport_endpoint(cls, new_message_callback, new_error_callback, log, loop, dump_to, bind, family):
        return (yield from cls._create_transport_endpoint(new_message_callback, new_error_callback, log, loop, dump_to, None, family, multicast=False))

    @classmethod
    @asyncio.coroutine
    def create_server_transport_endpoint(cls, new_message_callback, new_error_callback, log, loop, dump_to, bind, family):
        return (yield from cls._create_transport_endpoint(new_message_callback, new_error_callback, log, loop, dump_to, bind, family, multicast=True))
